...
class BookRouter {
    ...
    routes() {
        ...
        this.router.get('/get/:id', auth_1.default.ensureAdmin, book_controller_1.default.GetBookById);
        ...
        this.router.delete('/delete/:id', book_controller_1.default.DeleteBook);
    }
}
